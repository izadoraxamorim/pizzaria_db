...
INSERT INTO pizzaria.produtofinal (nome, tamanho, quantidade_em_estoque, valor_unitario_custo, valor_unitario_venda) VALUES
('Pizza Margherita', 'Grande', 20, 12.50, 34.90),
('Pizza Margherita', 'Média', 25, 9.80, 28.00),
('Pizza Pepperoni', 'Grande', 18, 15.80, 42.00),
('Pizza Pepperoni', 'Média', 22, 12.50, 32.00),
('Pizza Portuguesa', 'Grande', 15, 16.20, 45.00),
('Refrigerante Coca-Cola', '2L', 60, 4.75, 12.00),
('Refrigerante Guaraná', '2L', 55, 4.45, 10.00);
